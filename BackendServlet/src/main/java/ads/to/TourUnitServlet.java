...
public class TourUnitServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 ArrayList<TourUnitObject> tmp = dao.getAllTourUnit();
		 ...
		 out.append("<div class=\"modal fade\" id=\"notificationModal\" tabindex=\"-1\" aria-labelledby=\"modalLabel\" aria-hidden=\"true\">");
		               ...
		               out.append("<table class=\"table datatable table-striped\" style=\"font-size: small;\">");
		                 out.append("<thead >");
		                   out.append("<tr class=\"d-flex\">");
		                     out.append("<a href=\"Tour-Picked\" class=\"btn-primary\">");
		                     out.append("<div class=\"d-flex mt-3\"><div class=\"btn btn-success fw-bold me-3 ms-auto\"> <i class=\"bi bi-plus-circle-fill\"></i>");
		 ...
		 out.append("                    ");
		                 ...
		                 for(TourUnitObject to : tmp)
		                 {
		                   out.append("<tr>");
		                     ...
		                     out.append("<td id=\"tourOperator\">"+to.getTourOperator().getFirstname()+" "+to.getTourOperator().getLastname()+"</td>");
		                     out.append("<td id=\"departureDate\">"+to.getDepartureDate()+"</td>");
		                     out.append("<td id=\"returnDate\">"+to.getReturnDate()+"</td>");
		                     out.append("<td >");
		                       out.append("<a  href=\"Tour-Unit-Edit?tourUnitId="+to.getTourUnitId()+"\" class=\"btn btn-sm btn-primary\"><i class=\"bi bi-pencil-fill\"></i>");
		                       out.append("</a>");
		                       out.append("<a href=\"#\" class=\"btn btn-sm btn-danger\" data-bs-toggle=\"modal\" ");
		                   ...
		                   out.append("<div class=\"modal fade\" id=\"tourUnitDetailModal_" + to.getTourUnitId() + "\" tabindex=\"-1\" aria-labelledby=\"tourUnitDetailModalLabel_" + to.getTourUnitId() + "\" aria-hidden=\"true\">");
		                   out.append("  <div class=\"modal-dialog modal-lg\">");
		                   out.append("    <div class=\"modal-content\">");
		          		       out.append("<div class=\"modal-header\">");
		          		     out.append("<h5 class=\"modal-title\" id=\"tourUnitDetailModalLabel_" + to.getTourUnitId() + "\">Chi tiết đơn vị tour</h5>");
		          		       ...
		          		       out.append("<div class=\"modal-body\">");
		          		         out.append("<div class=\"row\">");
		          		           out.append("<div class=\"col-md-6\">");
		          		             out.append("<p><strong>ID đơn vị tour:</strong> <span id=\"tourUnitId\">"+to.getTourUnitId()+"</span></p>");
		          		             out.append("<p><strong>Trực thuộc tour:</strong> <span id=\"tourUnitId\">"+to.getTour().getTourName()+"</span></p>");
		          		             out.append("<p><strong>Giá người lớn:</strong> <span id=\"adultPrice\">"+to.getAdultTourPrice()+"</span></p>");
		          		             out.append("<p><strong>Giá trẻ em:</strong> <span id=\"childPrice\">"+to.getChildTourPrice()+"</span></p>");
		          		             out.append("<p><strong>Giá trẻ em 6-10 tuổi:</strong> <span id=\"status\">"+to.getToddlerTourPrice()+"</span></p>");
		          		             out.append("<p><strong>Giá trẻ sơ sinh:</strong> <span id=\"status\">"+to.getBabyTourPrice()+"</span></p>");
		          		             out.append("<p><strong>Giá phòng đơn:</strong> <span id=\"status\">"+to.getPrivateRoomPrice()+"</span></p>");
		          		             out.append("<p><strong>Tổng giá dịch vụ:</strong> <span id=\"status\">"+to.getTotalAdditionalCost()+"</span></p>");
		          		             out.append("<p><strong>Lễ hội:</strong> <span id=\"status\">"+to.getFestival().getFestivalName()+"</span></p>");
		          		             if(to.getDiscount() != null)
		          		             out.append("<p><strong>Giảm giá:</strong> <span id=\"status\">"+to.getDiscount().getDiscountName()+"</span></p>");

		          		           out.append("</div>");
		          		           out.append("<div class=\"col-md-6\">");
		          		             out.append("<p><strong>Ngày khởi hành:</strong> <span id=\"departureDate\">"+to.getDepartureDate()+"</span></p>");
		          		             out.append("<p><strong>Ngày trở về:</strong> <span id=\"returnDate\">"+to.getReturnDate()+"</span></p>");
		          		             out.append("<p><strong>Chi phí người lớn:</strong> <span id=\"status\">"+to.getAdultTourCost()+"</span></p>");
		          		             out.append("<p><strong>Chi phí trẻ em:</strong> <span id=\"status\">"+to.getChildTourCost()+"</span></p>");
		          		             out.append("<p><strong>Chi phí trẻ 6-10 tuổi:</strong> <span id=\"status\">"+to.getToddlerTourCost()+"</span></p>");
		          		             out.append("<p><strong>Chi phí trẻ sơ sinh:</strong> <span id=\"status\">"+to.getBabyTourCost()+"</span></p>");
		          		             out.append("<p><strong>Số người tham gia tối đa:</strong> <span id=\"status\">"+to.getMaximumCapacity()+"</span></p>");
		          		             out.append("<p><strong>Còn lại (chỗ):</strong> <span id=\"status\">"+to.getAvailableCapacity()+"</span></p>");
		          		             out.append("<p><strong>Người điều hành:</strong> <span id=\"manager\">"+to.getTourOperator().getFirstname()+" "+to.getTourOperator().getLastname()+"</span></p>");
		          		           out.append("</div>");
		          		         out.append("</div>");
		          		       out.append("</div>");
		          		       out.append("<div class=\"modal-footer\">");
		          		...
		          		out.append("<div class=\"modal\" id=\"staticBackdrop_" + to.getTourUnitId() + "\" data-bs-backdrop=\"static\" data-bs-keyboard=\"false\" tabindex=\"-1\"");
		          		out.append("aria-labelledby=\"staticBackdropLabel_" + to.getTourUnitId() + "\" aria-hidden=\"true\">");
		          		out.append("<div class=\"modal-dialog modal-dialog-centered\">");
		          		out.append("<div class=\"modal-content\">");

		          		out.append("<div class=\"modal-header\">");
		          		out.append("<h5 class=\"modal-title text-danger fw-bold fs-4\" id=\"staticBackdropLabel_" + to.getTourUnitId() + "\">Xác nhận xóa</h5>");
		          		out.append("<button type=\"button\" class=\"btn-close fs-3\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>");
		          		out.append("</div>");
		          		...
		          		out.append("<a href=\"Tour-Unit-Delete?tourUnitId=" + to.getTourUnitId() + "\" class=\"btn btn-primary\">Xác nhận</a>");
		          		out.append("</div>");
