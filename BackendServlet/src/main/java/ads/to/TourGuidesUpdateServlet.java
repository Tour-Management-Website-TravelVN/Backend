...
@WebServlet("/to/Tourguide-management/update")
public class TourGuidesUpdateServlet extends HttpServlet {
...
//            }
            ...
            if(success) {
                ...
                resp.sendRedirect(req.getContextPath() + "/to/Tourguide-management?success=update");
            }
            else {

                resp.sendRedirect(req.getContextPath() + "/to/Tourguide-management?error=update");
            }
        } catch (Exception e) {
            e.printStackTrace();

            resp.sendRedirect(req.getContextPath() + "/to/Tourguide-management");
        }
    }
}
