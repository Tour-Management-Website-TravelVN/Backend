...
public class TourUnitEditServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 out.append("    <form action=\"Tour-Unit-Edit?tourId="+tu.getTour().getTourId()+"\" method=\"post\">");
		 ...
		 out.append("          <button  type=\"submit\" class=\"btn btn-primary text-light\">Sửa tour unit</a>");
		 out.append("        </div>");
		 out.append("      </div>");
