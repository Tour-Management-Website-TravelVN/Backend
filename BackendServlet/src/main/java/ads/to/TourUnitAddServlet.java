...
public class TourUnitAddServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 out.append("    <form action=\"Tour-Unit-Add?tourId="+request.getParameter("tourId")+"\" method=\"post\">");
		 ...
		 TourObject tu = TourImpl.getInstance().getById(request.getParameter("tourId"));
		 ...
		 out.append("          <button  type=\"submit\" class=\"btn btn-primary text-light\">Thêm tour unit</a>");
		 out.append("        </div>");
		 out.append("      </div>");
		...
		out.append("");
		  ...
		  out.append("<script>");
		  char dayfix = TourImpl.getInstance().getById(request.getParameter("tourId")).getDuration().charAt(0);
