	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.append(
				"""
						  ...
						  <form class="needs-validation" id="tourForm" novalidate method="post" action="/adv/richtext" enctype="multipart/form-data">
						    <div class="row">
						      <div class="col">
						        <!-- ...existing code... -->
						        <div class="card">
						          <div class="card-body">
						            <h5 class="card-title">Nhập thông tin cho tour mới</h5>
						            ...
						            <!-- General Form Elements -->
						              ...
						              <div class="row mb-3">
						                ...
						                <div class="col-md-6  mt-3 mt-md-0">
						                  <div class="form-floating">
						                    <input class="form-control" type="file" id="tourImage" placeholder="Ảnh" multiple
						                      accept="/image/*">
						                    <label for="tourImage">Ảnh</label>
						                  </div>
						                </div>
						              </div>
						              ...
						              <div class="d-flex overflow-auto gap-3 p-2 border col-12 mb-3" style="height: 250px; width: auto;">
						                <div class="position-relative" style="min-width: 200px">
						                  ...
						                  <button class="btn btn-danger rounded-circle py-0 px-1 position-absolute top-0 end-0">
						                    <i class="bi bi-x text-white fw-bold fs-5"></i>
						                  </button>
						                </div>

						                <div class="position-relative" style="min-width: 200px">
						                  <img
						                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdvHiMePqz1GKwY38h5_Nfx0ga731PEC0l7A&s"
						                    class="img-thumbnail position-absolute top-0 end-0" style="width: 100%; height: 220px;" />
						                  <button class="btn btn-danger rounded-circle py-0 px-1 position-absolute top-0 end-0">
						                    <i class="bi bi-x text-white fw-bold fs-5"></i>
						                  </button>
						                ...
						                <div class="w-100 h100 d-flex align-items-center me-3">
						                  <i class="bi bi-plus-circle text-primary h1"></i>
						                </div>
						              </div>
						              ...
						              <div class="form-floating mb-3">
						                ...
						                <div class="invalid-feedback">Tên tour nằm trong khoảng 15 đến 255 ký tự.</div>
						              </div>
						              <div class="row mb-3">
						                <div class="col-md-6">
						                  <div class="form-floating">
						                    <input type="number" class="form-control" id="tourDuration" placeholder="Thời lượng tour" required>
						                    <label for="tourDuration">Thời lượng tour (ngày)</label>
						                    <div class="invalid-feedback">Từ 1 đến 60 ngày</div>
						              ...
						              <div class="row mb-3">
						                <div class="col-md-6">
						                  <div class="form-floating">
						                    <input type="text" class="form-control" id="tourIdealTime" placeholder="Thời điểm lý tưởng" required>
						                    <label for="tourIdealTime">Thời điểm lý tưởng</label>
						                    <div class="invalid-feedback">Độ dài từ 6 đến 255 ký tự</div>
						                  </div>
						                ...
						                <div class="col-md-6 mt-3 mt-md-0">
						                  <div class="form-floating">
						                    <select class="form-select" id="idCategory" required>
						                      ...
						                      <option value="5">Du lịch sinh thái</option>
						                      <option value="6">Du lịch mạo hiểm</option>
						                    </select>
						              ...
						              <div class="mb-0">
						                <div class="card pt-3">
						                  <div class="card-body">
						                    <label for="quill-included" class="mb-1">Đã bao gồm</label>
						                    <div id="quill-included"></div>
						                    <div class="invalid-feedback">Độ dài từ 20 ký tự trở lên.</div>
						                  </div>
						                </div>
						              </div>
						              ...
						              <div class="mb-0">
						                <div class="card pt-3 mt-0">
						                  <div class="card-body">
						                    <label for="quill-not-included" class="mb-1">Chưa bao gồm</label>
						                    <div id="quill-not-included"></div>
						                    <div class="invalid-feedback">Độ dài từ 20 ký tự trở lên.</div>
						                  </div>
						                </div>
						              </div>
						              <div class="mb-0">
						                <div class="card pt-3">
						                  <div class="card-body">
						                    <label for="quill-description" class="mb-1">Mô tả</label>
						              ...
						              <div class="row mb-3">
						                <legend class="col-form-label col-sm-auto pt-0">Phương tiện</legend>
						                <div class="col-sm-9 ms-0">
						                  <div class="form-check form-check-inline">
						                    <input class="form-check-input" type="checkbox" id="vehicleCar" checked>
						                    <label class="form-check-label" for="vehicleCar">Ô tô</label>
						                  </div>
						                  <div class="form-check form-check-inline">
						                    <input class="form-check-input" type="checkbox" id="vehiclePlane" checked>
						                    <label class="form-check-label" for="vehiclePlane">Máy bay</label>
						                  </div>
						                  <div class="form-check form-check-inline">
						                    <input class="form-check-input" type="checkbox" id="vehicleTrain" checked>
						                    <label class="form-check-label" for="vehicleTrain">Tàu hoả</label>
						                  </div>
						                  <div class="form-check form-check-inline">
						                    <input class="form-check-input" type="checkbox" id="vehicleShip" checked>
						                    <label class="form-check-label" for="vehicleShip">Tàu thuỷ</label>
						                  </div>
						                </div>
						              </div>
						              <div class="row mb-3 d-flex justify-content-center justify-content-md-end">
						                <div class="col-auto">
						                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
						                    style="width: 150px;">Hủy bỏ</button>
						                </div>
						                <div class="col-auto">
						                  <button type="submit" class="btn btn-primary" style="width: 150px;">Thêm tour mới</button>
						                </div>
						                ...
						                <div class="modal-dialog modal-dialog-centered">
						                  <div class="modal-content">
						                    ...
						                    <div class="modal-body">
						                      Thông tin tour sẽ không được lưu?
						                    </div>
						        ...
						        <div class="card">
						          <div class="card-body">
						            <h5 class="card-title">Chương trình tour</h5>
						            <div class="card">
						              <div class="card-header bg-secondary text-white text-center text-md-start">Ngày <span class="day">1</span></div>
						                ...
						                <li class="list-group-item pb-4">
						                  <div class="row">
						                    ...
						                    <div class="col-12 mt-2 h-100">
						                      <label class="mb-1">Nội dung chương trình</label>
						                      <div class="quill-editor-2"></div>
						                      <textarea name="content" id="quillContent" hidden></textarea>
						                    </div>
						            ...
						            <button type="submit" id="saveAll" class="btn btn-primary float-end" style="width: 150px;">Lưu</button>
						          </div>
		...
		out.append("""
						<script>
				  // Khởi tạo Quill Editor cho "Đã bao gồm"
				  var quillIncluded = new Quill('#quill-included', {
				    theme: 'snow'
				  });

				  // Khởi tạo Quill Editor cho "Chưa bao gồm"
				  var quillNotIncluded = new Quill('#quill-not-included', {
				    theme: 'snow'
				  });

				  // Khởi tạo Quill Editor cho "Mô tả"
					...
					document.getElementById('tourForm').addEventListener('submit', function () {
					  document.querySelectorAll('.quill-editor-2').forEach(function (el, index) {
				            ...
				            if (quill) {
				                ...
				                document.getElementById('quillContent').value = contentHtml;
				            } else {
				                console.log("HELLO2");
				            }
				        });
