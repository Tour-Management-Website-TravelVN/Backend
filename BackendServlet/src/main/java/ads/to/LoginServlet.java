...
public class LoginServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 out.append("                  </div>");
		 out.append("");
		 out.append("                  <form name=\"frmLogin\" class=\"row g-3 needs-validation\" novalidate>");
		 out.append("");
		 ...
		 out.append("                      <input type=\"password\" name=\"txtPassword\" class=\"form-control\" id=\"txtPassword\" required>");
		 ...
		 out.append("                    </div>");
		 out.append("                    <div class=\"col-12\">");
		 out.append("                      <button class=\"btn btn-primary w-100\" type=\"button\" onclick=\"login(document.frmLogin)\">Đăng nhập</button>");
		 out.append("                    </div>");
		 out.append("                    <div class=\"col-12\">");
		 out.append("                      <p class=\"small mb-0\">Bạn không có tài khoản? <a href=\"pages-register.html\">Tạo tài khoản mới</a></p>");
		 out.append("                    </div>");
		 out.append("                  </form>");
		 out.append("                </div>");
		 out.append("              </div>");
...
//		doGet(req, resp);
		...
		if(name!=null && !"".equalsIgnoreCase(name) && pass!=null && !"".equalsIgnoreCase(pass)){
			...
			BookingObject item = b.getObject(1, "P");
			
			if(item.getNote().equalsIgnoreCase(name)) {
//			if(name.equalsIgnoreCase("admin21345") && pass.equalsIgnoreCase("@12345621")) {
//				
//				//Tham chiếu phiên làm việc
				HttpSession session = req.getSession();
//				session.setAttribute("userLogined", "ok");
				
				session.setAttribute("userLogined", item);
				
//				System.out.println("README");
				resp.sendRedirect("/adv/userview");
