...
public class TourEditServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 out.append("");
		   out.append("<title>Sửa tour</title>");
		 ...
		 out.append("");
		     out.append("<div class=\"pagetitle d-flex\">");
		       out.append("<h1>Sửa thông tin tour</h1>");
		       out.append("<nav class=\"ms-auto\">");
		         out.append("<ol class=\"breadcrumb\">");
		           ...
		           out.append("<li class=\"breadcrumb-item active\">Sửa thông tin tour</li>");
		         out.append("</ol>");
		       out.append("</nav>");
		 ...
		 out.append("<div class=\"card\">");
		   out.append("<div class=\"card-body\">");
		     out.append("<h5 class=\"card-title\">Nhập thông tin mới</h5>");
		 out.append("");
		     ...
		     out.append("<form>");
		       out.append("<div class=\"row mb-3\">");
		         out.append("<div class=\"col-md-6\">");
		           out.append("<div class=\"form-floating\">");
		             out.append("<input type=\"text\" class=\"form-control\" id=\"tourId\" placeholder=\"Mã tour\">");
		             out.append("<label for=\"tourId\">Mã tour</label>");
		           out.append("</div>");
		         out.append("</div>");
		         out.append("<div class=\"col-md-6\">");
		           out.append("<div class=\"form-floating\">");
		             out.append("<input class=\"form-control\" type=\"file\" id=\"tourImage\" placeholder=\"Ảnh\">");
		             out.append("<label for=\"tourImage\">Ảnh</label>");
		           out.append("</div>");
		         out.append("</div>");
		       out.append("</div>");
		       ...
		       out.append("<div class=\"row mb-3\">");
		         out.append("<div class=\"col-md-6\">");
		           out.append("<div class=\"form-floating\">");
		         out.append("<input type=\"text\" class=\"form-control\" id=\"tourDuration\" placeholder=\"Thời lượng tour\">");
		         out.append("<label for=\"tourDuration\">Thời lượng tour</label>");
		         out.append("</div>");
		       out.append("</div>");
		       out.append("<div class=\"col-md-6\">");
		       out.append("<div class=\"form-floating\">");
		         out.append("<input type=\"text\" class=\"form-control\" id=\"tourDeparture\" placeholder=\"Nơi khởi hành\">");
		         out.append("<label for=\"tourDeparture\">Nơi khởi hành</label>");
		       out.append("</div>");
		     out.append("</div>");
		     out.append("</div>");
		       out.append("<div class=\"form-floating mb-3\">");
		         out.append("<input type=\"text\" class=\"form-control\" id=\"tourAttractions\" placeholder=\"Điểm tham quan\">");
		         out.append("<label for=\"tourAttractions\">Điểm tham quan</label>");
		       out.append("</div>");
		       out.append("<div class=\"form-floating mb-3\">");
		         out.append("<input type=\"text\" class=\"form-control\" id=\"tourTarget\" placeholder=\"Đối tượng nhắm tới\">");
		         out.append("<label for=\"tourTarget\">Đối tượng nhắm tới</label>");
		 out.append("     ");
		       out.append("</div>");
		       out.append("<div class=\"row mb-3\">");
		         out.append("<div class=\"col-md-6\">");
		           out.append("<div class=\"form-floating\">");
		         out.append("<input type=\"text\" class=\"form-control\" id=\"tourIdealTime\" placeholder=\"Thời điểm lý tưởng\">");
		         out.append("<label for=\"tourIdealTime\">Thời điểm lý tưởng</label>");
		         out.append("</div>");
		       out.append("</div>");
		       out.append("<div class=\"col-md-6\">");
		       out.append("<div class=\"form-floating\">");
		         out.append("<input type=\"text\" class=\"form-control\" id=\"idCategory\" placeholder=\"Mã thể loại\">");
		         out.append("<label for=\"idCategory\">Mã thể loại</label>");
		       out.append("</div>");
		     out.append("</div>");
		     out.append("</div>");
		       out.append("<div class=\"form-floating mb-3\">");
		         out.append("<div class=\"card pt-3\">");
		           out.append("<div class=\"card-body\">");
		             out.append("<label for=\"quill-included\">Đã bao gồm</label>");
		 ...
		 out.append("      ");
		       out.append("<div class=\"form-floating mb-3\">");
		         out.append("<div class=\"card pt-3\">");
		           out.append("<div class=\"card-body\">");
		             out.append("<label for=\"quill-not-included\">Chưa bao gồm</label>");
		             out.append("<div id=\"quill-not-included\" class=\"quill-editor-full\"></div>");
		           out.append("</div>");
		         out.append("</div>");
		       out.append("</div>");
		       out.append("<div class=\"form-floating mb-3\">");
		         out.append("<div class=\"card pt-3\">");
		           out.append("<div class=\"card-body\">");
		             out.append("<label for=\"quill-description\">Mô tả</label>");
		             out.append("<div id=\"quill-description\" class=\"quill-editor-full\"></div>");
		           out.append("</div>");
		         out.append("</div>");
		       out.append("</div>");
		       out.append("<div class=\"row mb-3\">");
		         out.append("<legend class=\"col-form-label col-sm-2 pt-0\">Phương tiện</legend>");
		         out.append("<div class=\"col-sm-10\">");
		           out.append("<div class=\"form-check form-check-inline\">");
		             out.append("<input class=\"form-check-input\" type=\"checkbox\" id=\"vehicleCar\">");
		             out.append("<label class=\"form-check-label\" for=\"vehicleCar\">Ô tô</label>");
		           out.append("</div>");
		           out.append("<div class=\"form-check form-check-inline\">");
		             out.append("<input class=\"form-check-input\" type=\"checkbox\" id=\"vehiclePlane\" checked>");
		             out.append("<label class=\"form-check-label\" for=\"vehiclePlane\">Máy bay</label>");
		           out.append("</div>");
		           out.append("<div class=\"form-check form-check-inline\">");
		             out.append("<input class=\"form-check-input\" type=\"checkbox\" id=\"vehicleTrain\" checked>");
		             out.append("<label class=\"form-check-label\" for=\"vehicleTrain\">Tàu hoả</label>");
		           out.append("</div>");
		           out.append("<div class=\"form-check form-check-inline\">");
		             out.append("<input class=\"form-check-input\" type=\"checkbox\" id=\"vehicleShip\" checked>");
		             out.append("<label class=\"form-check-label\" for=\"vehicleShip\">Tàu thuỷ</label>");
		           out.append("</div>");
		         out.append("</div>");
		       out.append("</div>");
		       out.append("<div class=\"row mb-3 d-flex\">");
		         out.append("<div class=\"col ms-auto\">");
		           out.append("<a href=\"Tour_management.html\" class=\"btn btn-danger text-light\">Huỷ bỏ</a>");
		         out.append("</div>");
