...
public class AccountRecentDeleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.append("              <a href=\"#\"><span class=\"badge rounded-pill bg-primary p-2 ms-2\">Xem tất cả</span></a>");
		out.append("            </li>");
		out.append("            <li>");
		...
		out.append("          <li class=\"breadcrumb-item active\">Tài khoản đã xóa gần đây</li>");
		out.append("        </ol>");
		out.append("      </nav>");
