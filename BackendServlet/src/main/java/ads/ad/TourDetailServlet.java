...
@WebServlet("/ad/tour-management/tour_detail")
public class TourDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(tourId == null) {
			response.sendRedirect("/adv/ad/tour-management");
			return;
		};
		...
		out.append(TourLibraryAD.viewTourDetail(tourId, actionTour));
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(req.getParameter("action").equalsIgnoreCase("del") && tourId!=null) {
			if(TourFunctionImpl.getInstance().deleteTourByTourId(tourId)) {
				...
				resp.sendRedirect("/adv/ad/tour-management");
			} else {
