...
public class DiscountEditServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.append("");
		  out.append("<title>Sửa chương trình giảm giá</title>");
		...
		out.append("");
		    out.append("<div class=\"pagetitle d-flex\">");
		      out.append("<h1>Sửa thông tin chương trình giảm giá</h1>");
		      out.append("<nav class=\"ms-auto\">");
		        out.append("<ol class=\"breadcrumb\">");
		          ...
		          out.append("<li class=\"breadcrumb-item active\">Sửa thông tin chương trình giảm giá</li>");
		        out.append("</ol>");
		      out.append("</nav>");
		      ...
		      out.append("<div class=\"row mb-3\">");
		        out.append("<div class=\"col-md-6\">");
		          out.append("<div class=\"form-floating\">");
		            out.append("<input type=\"text\" class=\"form-control\" id=\"discountId\" placeholder=\"Mã chương trình giảm giá\">");
		            out.append("<label for=\"tourId\">Mã chương trình giảm giá</label>");
		          out.append("</div>");
		        out.append("</div>");
		        out.append("<div class=\"col-md-6\">");
		          out.append("<div class=\"form-floating\">");
		            out.append("<input type=\"text\" class=\"form-control\" id=\"discountValue\" placeholder=\"Giá trị\">");
		            out.append("<label for=\"discountValue\">Giá trị giảm giá</label>");
		          out.append("</div>");
		        out.append("</div>");
		      out.append("</div>");
		      out.append("<div class=\"form-floating mb-3\">");
		        out.append("<input type=\"text\" class=\"form-control\" id=\"tourName\" placeholder=\"Tên chương trình giảm giá\">");
		        out.append("<label for=\"discountName\">Tên chương trình giảm giá</label>");
		      out.append("</div>");
		      out.append("<div class=\"row mb-3\">");
		        out.append("<div class=\"col-md-6\">");
		          out.append("<div class=\"form-floating\">");
		        out.append("<input type=\"text\" class=\"form-control\" id=\"discountUnit\" placeholder=\"Đơn vị giảm giá\">");
		        out.append("<label for=\"discountUnit\">Đơn vị</label>");
		        out.append("</div>");
		      out.append("</div>");
		out.append("     ");
		      out.append("<div class=\"row mb-3 d-flex mt-3\">");
		        out.append("<div class=\"col ms-auto\">");
		          out.append("<a href=\"Discount-management.html\" class=\"btn btn-danger text-light\">Huỷ bỏ</a>");
		        out.append("</div>");
